...
// -- Audit Checker feature tour -------------------------------
if (window.DSCPTutorial) {
    window.DSCPTutorial.register('audit-check', () => {
        ...
        return [
            {
                "id": "ac-welcome",
                "title": "<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z\"/><polyline points=\"14 2 14 8 20 8\"/><line x1=\"16\" y1=\"13\" x2=\"8\" y2=\"13\"/><line x1=\"16\" y1=\"17\" x2=\"8\" y2=\"17\"/><polyline points=\"10 9 9 9 8 9\"/></svg> Audit Check",
                "text": "<p>A two-in-one audit tool powered by AI. <strong>Create</strong> structured audit documents from screenshots, or <strong>validate</strong> an existing audit PDF for completeness and compliance.</p>"
            },
            {
                "id": "ac-modes",
                "attachTo": { "element": ".mode-tabs", "on": "bottom" },
                "title": "<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"3\" y=\"3\" width=\"7\" height=\"7\" rx=\"1\"/><rect x=\"14\" y=\"3\" width=\"7\" height=\"7\" rx=\"1\"/><rect x=\"3\" y=\"14\" width=\"7\" height=\"7\" rx=\"1\"/><rect x=\"14\" y=\"14\" width=\"7\" height=\"7\" rx=\"1\"/></svg> Choose your mode",
                "text": "<p>Use the tabs to switch between the two modes:<br><strong>Create Audit</strong> &mdash; build a new audit from screenshots.<br><strong>Check Audit</strong> &mdash; validate an existing audit PDF.</p>"
            },
            {
                "id": "ac-create",
                "attachTo": { "element": "#audit-title", "on": "right" },
                "title": "<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 20h9\"/><path d=\"M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z\"/></svg> Create Audit &mdash; fill in details",
                "text": "<p>Give your audit a clear <strong>title</strong> and an optional <strong>description</strong>. These appear in the generated PDF header, so make them descriptive.</p>"
            },
            {
                "id": "ac-upload",
                "attachTo": { "element": "#upload-area", "on": "right" },
                "title": "<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4\"/><polyline points=\"17 8 12 3 7 8\"/><line x1=\"12\" y1=\"3\" x2=\"12\" y2=\"15\"/></svg> Upload screenshots",
                "text": "<p>Drag &amp; drop or click to upload your screenshots (<strong>JPG / PNG</strong> only, max 10 MB each).</p><p>You can upload multiple images and reorder them &mdash; the order determines how they appear in the generated document.</p>"
            },
            {
                "id": "ac-check",
                "attachTo": { "element": "[data-mode='checker']", "on": "bottom" },
                "title": "<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M9 11l3 3L22 4\"/><path d=\"M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11\"/></svg> Check Audit mode",
                "text": "<p>Switch to <strong>Check Audit</strong> to upload an existing audit PDF. The AI reviews it for completeness, correctness, and compliance &mdash; no screenshots needed.</p>"
            },
            {
                "id": "ac-warning",
                "title": "<svg width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z\"/><line x1=\"12\" y1=\"9\" x2=\"12\" y2=\"13\"/><line x1=\"12\" y1=\"17\" x2=\"12.01\" y2=\"17\"/></svg> AI disclaimer",
                "text": "<p>Results are generated by AI and should be treated as a <strong>starting point, not a final verdict</strong>.</p><p>Always have a qualified reviewer validate the output before using it in an official audit context.</p>"
            },
            {
                "id": "ac-result",
                ...
                "text": "<p><strong>Create mode:</strong> A downloadable audit PDF built from your screenshots, ready to share with Analysis.</p><p><strong>Check mode:</strong> A findings report with pass/fail status per section and suggested improvements.</p>"
            }
        ];;
    });
}
